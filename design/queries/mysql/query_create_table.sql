CREATE TABLE "Room Room" (
	...
	"Administrative Id" INT, FOREIGN KEY ("Administrative Id") REFERENCES `Administrative`(Id),
	"Doctor Id" INT, FOREIGN KEY ("Doctor Id") REFERENCES `Doctor`(Id),
	"Emergency Id" INT, FOREIGN KEY ("Emergency Id") REFERENCES `Emergency`(Id),
	"Inpatient Id" INT, FOREIGN KEY ("Inpatient Id") REFERENCES `Inpatient`(Id),
	"Outpatient Id" INT, FOREIGN KEY ("Outpatient Id") REFERENCES `Outpatient`(Id),
	"Diagnosis Id" INT, FOREIGN KEY ("Diagnosis Id") REFERENCES `Diagnosis`(Id),
	"Surgical Id" INT, FOREIGN KEY ("Surgical Id") REFERENCES `Surgical`(Id),
	"Treatment Id" INT, FOREIGN KEY ("Treatment Id") REFERENCES `Treatment`(Id),
	"Support Id" INT, FOREIGN KEY ("Support Id") REFERENCES `Support`(Id),
	"Pharmacy Id" INT, FOREIGN KEY ("Pharmacy Id") REFERENCES `Pharmacy`(Id),
	"Residential Id" INT, FOREIGN KEY ("Residential Id") REFERENCES `Residential`(Id),
	"Visitor Id" INT, FOREIGN KEY ("Visitor Id") REFERENCES `Visitor`(Id),
	"Utility Id" INT, FOREIGN KEY ("Utility Id") REFERENCES `Utility`(Id),
	"Misc Id" INT, FOREIGN KEY ("Misc Id") REFERENCES `Misc`(Id),
);
CREATE TABLE "Room Administrative" (
	"Id" INT AUTO_INCREMENT PRIMARY KEY,
	"Name" VARCHAR(255),
	"Floor" INT,
	"Staff Id" INT, FOREIGN KEY ("Staff Id") REFERENCES `Staff`(Id),
	"Patient Id" INT NOT NULL, FOREIGN KEY ("Patient Id") REFERENCES `Patient`(Id),
	"Inventory Id" INT, FOREIGN KEY ("Inventory Id") REFERENCES `Inventory`(Id),
	"Executive Level" INT,
	"Department Id" INT, FOREIGN KEY ("Department Id") REFERENCES `Department`(Id),
);
...
CREATE TABLE "Consumable Consumable" (
	"Id" INT AUTO_INCREMENT PRIMARY KEY,
	"Pharmaceutical Id" INT, FOREIGN KEY ("Pharmaceutical Id") REFERENCES `Pharmaceutical`(Id),
	"Medical Supplies Id" INT, FOREIGN KEY ("Medical Supplies Id") REFERENCES `Medical Supplies`(Id),
);
...
CREATE TABLE "Inventory Inventory" (
	"Id" INT AUTO_INCREMENT PRIMARY KEY,
	"Edibles Id" INT, FOREIGN KEY ("Edibles Id") REFERENCES `Edibles`(Id),
	"Medical Equipment Id" INT, FOREIGN KEY ("Medical Equipment Id") REFERENCES `Medical Equipment`(Id),
	"Supplies Id" INT, FOREIGN KEY ("Supplies Id") REFERENCES `Supplies`(Id),
	"Electronic Id" INT, FOREIGN KEY ("Electronic Id") REFERENCES `Electronic`(Id),
	"Vehicle Id" INT, FOREIGN KEY ("Vehicle Id") REFERENCES `Vehicle`(Id),
);
CREATE TABLE "Inventory Edible" (
	...
	"Expiration Date" TIMESTAMP NOT NULL,
	"Quantity" INT,
	"Kitchen Id" INT, FOREIGN KEY ("Kitchen Id") REFERENCES `Kitchen`(Id),
);
CREATE TABLE "Inventory Medical Equipment" (
	...
	"Purchase Date" TIMESTAMP NOT NULL,
	"Expiration Date" TIMESTAMP NOT NULL,
	"Room Id" INT, FOREIGN KEY ("Room Id") REFERENCES `Room`(Id),
	"Availability" TINYINT(1),
...
CREATE TABLE "Document Lab Report" (
	...
	"Approved By Id" INT NOT NULL, FOREIGN KEY ("Approved By Id") REFERENCES `Approved By`(Id),
	"Description" TEXT,
	"Test  Date" TIMESTAMP NOT NULL,
	"Result Date" TIMESTAMP NOT NULL,
	"Patient Id" INT NOT NULL, FOREIGN KEY ("Patient Id") REFERENCES `Patient`(Id),
	"Room Id" INT, FOREIGN KEY ("Room Id") REFERENCES `Room`(Id),
	"Inventory Id" INT, FOREIGN KEY ("Inventory Id") REFERENCES `Inventory`(Id),
	"Schedule Id" INT NOT NULL, FOREIGN KEY ("Schedule Id") REFERENCES `Schedule`(Id),
...
CREATE TABLE "Document Insurance" (
	...
	"End Date" TIMESTAMP NOT NULL,
	"Report Id" INT, FOREIGN KEY ("Report Id") REFERENCES `Report`(Id),
	"Approval Date" TIMESTAMP NOT NULL,
